This is a Qualified assignment design to practice the coding skills and to build an application that will help you encode and decode all kinds of fun messages?
